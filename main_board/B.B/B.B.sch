...
U 1 1 5FC8A4A2
P 7900 5400
F 0 "J2" H 7850 6000 50  0000 L CNN
F 1 "Conn_01x11" V 8000 4850 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x11_P2.54mm_Vertical" H 7900 5400 50  0001 C CNN
...
F9 "A9-TX" I L 7800 2350 50 
F10 "A9-RX" I L 7800 2425 50 
$EndSheet
Wire Wire Line
	6550 3200 7800 3200
Wire Wire Line
...
Wire Wire Line
	2150 1500 2350 1500
$Sheet
S 8875 4850 575  1150
U 5FA9675D
F0 "next-board00" 50
F1 "next-board.sch" 50
F2 "SCL" I L 8875 5700 50 
F3 "SDA" I L 8875 5600 50 
F4 "INT" I L 8875 5500 50 
F5 "SHUTDOWN" I L 8875 5400 50 
F6 "3V3" I L 8875 5800 50 
F7 "WS2812" I L 8875 5300 50 
F8 "5V" I L 8875 4900 50 
F9 "GND" I L 8875 5100 50 
F10 "LDC-GND" I L 8875 5900 50 
$EndSheet
$Comp
L B.B-rescue:Conn_01x11-Connector_Generic-B.B-rescue J3
U 1 1 5FC91920
P 8100 5400
F 0 "J3" H 8050 6000 50  0000 L CNN
F 1 "Conn_01x11" V 8200 4850 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x11_P2.54mm_Vertical" H 8100 5400 50  0001 C CNN
...
F0 "charger00" 50
F1 "charger.sch" 50
F2 "VCC" I L 3750 2700 50 
F3 "BAT" I R 4600 2700 50 
$EndSheet
$Comp
...
F0 "expanz00" 50
F1 "expanz.sch" 50
F2 "3V3" I L 7800 2950 50 
F3 "5V" I L 7800 2750 50 
F4 "VCC" I L 7800 2850 50 
F5 "ENC_OUT_0" I L 7800 3500 50 
F6 "MOTOR" I L 7800 3075 50 
F7 "IR-INPUT" I L 7800 3400 50 
F8 "IR-OUT" I L 7800 3325 50 
F9 "piezo" I L 7800 3200 50 
$EndSheet
Wire Wire Line
	7800 2850 7500 2850
Wire Wire Line
...
F0 "servos00" 50
F1 "servos.sch" 50
F2 "5V" I L 7800 3775 50 
F3 "S0" I L 7800 4000 50 
F4 "S1" I L 7800 4075 50 
F5 "S2" I L 7800 4150 50 
F6 "S3" I L 7800 4225 50 
F7 "3.3V" I L 7800 3850 50 
F8 "T0" I L 7800 4375 50 
F9 "T1" I L 7800 4450 50 
F10 "T2" I L 7800 4525 50 
F11 "T3" I L 7800 4600 50 
$EndSheet
Wire Wire Line
	7800 3775 7650 3775
Wire Wire Line
...
F0 "ESP3200" 50
F1 "ESP32.sch" 50
F2 "IO27" I R 6550 4000 50 
F3 "IO39" I L 5550 3750 50 
F4 "IO36" I L 5550 3100 50 
F5 "IO35" I R 6550 4600 50 
F6 "IO34" I R 6550 2050 50 
F7 "IO33" I R 6550 2350 50 
F8 "IO32" I R 6550 2425 50 
F9 "IO23" I R 6550 1900 50 
F10 "IO22" I R 6550 1800 50 
F11 "IO21" I R 6550 3200 50 
F12 "IO19" I R 6550 5300 50 
F13 "IO18" I R 6550 5400 50 
F14 "3V3" I L 5550 1700 50 
F15 "IO0-up" I R 6550 4525 50 
F16 "IO5-up" I L 5550 2150 50 
F17 "IO2-down" I R 6550 4225 50 
F18 "IO12-down" I R 6550 3075 50 
F19 "IO15-up" I R 6550 4450 50 
F20 "IO4" I R 6550 3500 50 
F21 "IO13" I R 6550 4150 50 
F22 "IO14" I L 5550 2000 50 
F23 "IO25" I R 6550 4075 50 
